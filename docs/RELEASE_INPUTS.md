...
6. Validate foreground, background and notification-click behavior on physical devices. Notification click URLs must be relative/internal ChatPalez routes; external URLs are deliberately ignored.
